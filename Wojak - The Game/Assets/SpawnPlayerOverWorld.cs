...
public class SpawnPlayerOverWorld : MonoBehaviour
{
    // Start is called before the first frame update

    public Vector3 playerSpawnPos;
    public bool globalIsFacingForward;
    ...
    public void SpawnPlayerPosition(Vector3 _playerPos, bool _isFacingForward)
        {
        playerSpawnPos = _playerPos;
        globalIsFacingForward = _isFacingForward;
        }
